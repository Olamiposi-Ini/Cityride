...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  static const Color _bgTop = AppColors.surfaceAlt;
  static const Color _textDark = AppColors.darkTextAlt;
  static const Color _textGrey = AppColors.lightGreyText;
...
class _Indicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      width: isActive ? 20 : 6,
      decoration: BoxDecoration(
        color: isActive ? AppColors.primaryDark : AppColors.indicatorInactive,
