...
class AuthService {
  ...
  Future<void> _saveTokenFromResponse(String responseBody) async {
    try {
  ...
  Future<http.Response> updateProfile({
    ...
    final Map<String, dynamic> bodyPayload = {};
    if (firstName != null) bodyPayload["firstName"] = firstName;
    if (lastName != null) bodyPayload["lastName"] = lastName;
    ...
    try {
      ...
      print('[ERROR] Update Profile Exception: $e');
      rethrow;
    }
  }
}
